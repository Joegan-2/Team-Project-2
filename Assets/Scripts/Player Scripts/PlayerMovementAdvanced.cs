...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private float lowJumpMultiplier = 2.95f;
    bool readyToJump;
    ...
    [Header("Exception Bools")]
    private bool crouchedInAir;
    private bool crouchedUnderStuff;

    private bool slidInAir;
    ...
    private void MyInput()
    {
        ...
        {
            if(Input.GetKey(crouchKey) || Input.GetKey(slideKey))
            {
        ...
        else if (Input.GetKey(crouchKey) && crouchedInAir && grounded)
        {
            crouchedInAir = false;
            transform.localScale = new Vector3(transform.localScale.x, crouchYScale, transform.localScale.z);
            rb.AddForce(Vector3.down * 5f, ForceMode.Impulse); 
        }
        else if (crouchedInAir && grounded)
        {
            crouchedInAir = false;
        }
